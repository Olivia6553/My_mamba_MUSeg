...
class args:
    ...
    if branch == "roi":
        model_config_path = project_path + "configs/vssm/vssm_tiny_MUSeg_out20.yaml"
    else:
        model_config_path = project_path + "configs/vssm/vssm_tiny_MUSeg_bg.yaml"

    train_config_path = project_path + "configs/train/vssm_tiny_MUSeg_rayleigh_seed1024.yaml"
