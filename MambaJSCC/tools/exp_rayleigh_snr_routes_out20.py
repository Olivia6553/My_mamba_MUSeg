...
def main():
    ...
    class RoiArgs:
        model_config_path = str(project_path / "configs/vssm/vssm_tiny_MUSeg_out20.yaml")
        train_config_path = str(project_path / "configs/train/vssm_tiny_MUSeg_rayleigh.yaml")
